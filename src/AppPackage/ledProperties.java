 ...
 * @author Hamad
 */
public class ledProperties extends javax.swing.JFrame {
    led l;
    PanelFrontEndView pf;
    public ledProperties() {
        initComponents();
    }
    public ledProperties(led l,PanelFrontEndView pf) {
        initComponents();
        this.l=l;
        this.pf=pf; 
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Set Led Properties");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ledProperties.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ledProperties().setVisible(true);
            }
        });
    }
